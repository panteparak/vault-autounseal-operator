...
from kubernetes.client import V1CustomResourceDefinition, V1CustomResourceDefinitionSpec, \
    V1CustomResourceDefinitionVersion, V1CustomResourceValidation, V1JSONSchemaProps, \
    V1CustomResourceDefinitionNames, V1ObjectMeta
import yaml
...
class CRDGenerator:
                                    ...
                                    "podSelector": V1JSONSchemaProps(
                                        ...
                                        properties={
                                            "matchLabels": V1JSONSchemaProps(
                                                type="object",
                                                additional_properties=V1JSONSchemaProps(type="string")
                                            )
                                        }
                                    ),
        ...
        crd_dict = {
            ...
            "spec": {
                ...
                "versions": [{
                    ...
                    "schema": {
                        "openAPIV3Schema": cls._schema_to_dict(version.schema.open_api_v3_schema)
                    },
                    "subresources": {
                        "status": {}
                    }
    ...
    def _schema_to_dict(cls, schema: V1JSONSchemaProps) -> Dict[str, Any]:
        ...
        if schema.additional_properties:
            result["additionalProperties"] = cls._schema_to_dict(schema.additional_properties)
