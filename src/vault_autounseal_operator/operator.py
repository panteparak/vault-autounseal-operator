...
from .models import VaultUnsealConfigSpec, VaultUnsealConfigStatus, VaultInstance
...
class VaultUnsealOperator:
    ...
    async def setup_vault_instance(self, instance_config: Dict[str, Any], namespace: str):
    ...
    async def unseal_vault_instance(self, instance_config: Dict[str, Any], namespace: str) -> Dict[str, Any]:
        instance_name = instance_config['name']
        client_key = f"{namespace}/{instance_name}"
