...
class TestSecurityEdgeCases:
    ...
    def test_resource_exhaustion_protection(self):
        ...
        too_many_keys = [base64.b64encode(f"key{i}".encode()).decode() for i in range(20)]
    ...
    def test_regex_dos_protection(self):
        ...
        for pattern in regex_dos_patterns:
            ...
            assert end - start < 1.0, f"Regex took too long for pattern: {pattern[:50]}..."